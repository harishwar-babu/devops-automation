...
public class WithDrawServiceImpl implements WithDrawService {
    ...
    public TransactionDetailsResponseDto makeTransaction(TransactionDetailsRequestDto transactionDetailsRequest) throws
        ...
        if(accountDetails.getBankBalance()<transactionDetailsRequest.getAmount()){
            throw new LessThanBankBalanceException(String.format(ApplicationConstant.LESS_THAN_BANK_BALANCE_MESSAGE,
                    accountDetails.getBankBalance()));
        }
        ...
        transactionDetails.setWithdrawAmount(transactionDetailsRequest.getAmount());
        ...
        transactionDetails.setTransactionTypeDescription(transactionTypeRepository.getReferenceById(
                TransactionTypeUtil.WITHDRAW.getTransactionTypeCode()));
        accountDetailsRepository.save(accountDetails);
        transactionDetailsRepository.save(transactionDetails);
        log.info("Amount of Rs: {} has been withdrawn from account: {} ",
